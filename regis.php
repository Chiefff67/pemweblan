    ...
    <div class="font-[sans-serif] bg-white md:h-screen">
        <div class="grid md:grid-cols-2 items-center gap-8 h-full">
            ...
            <div class="flex items-center p-6 h-full w-full">
                <form id="regisForm" method="POST" class="max-w-lg w-full mx-auto">
                    <div class="mb-12">
                        <h3 class="text-blue-500 md:text-3xl text-2xl font-extrabold max-md:text-center">Registrasi</h3>
                    </div>

                    <div>
                        <label class="text-gray-800 text-xs block mb-2">Nama Lengkap</label>
                        <div class="relative flex items-center">
                            <input name="name" type="text" id="name" required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Masukkan Nama" />
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative flex items-center">
                            <input name="username" type="text" id="user" required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Masukkan username" />
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative flex items-center">
                            <input name="password" type="password" id="pass" required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Masukkan password" />
        ...
        $(document).ready(function() {
            $("#submitRegis").click(function() {
                $.ajax({
                    ...
                    data: {
                        name: $("#name").val(),
                        username: $("#user").val(), // Sesuaikan dengan ID input "user"
                        password: $("#pass").val(), // Sesuaikan dengan ID input "pass"
                    },
                    success: function(result) {
                        Swal.fire({
                            title: result === "Berhasil" ? "Good job!" : "Gagal!",
                            text: result,
                            icon: result === "Berhasil" ? "success" : "error",
                        });
                    },
                });
            });
